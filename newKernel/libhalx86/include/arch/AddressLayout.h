...
4 GiB +-------------------------+ KERNEL_IO_MEMORY_END = 0xFFFFFFFF
      ...
      |                         |
      | Unused Stack Guard Page |
      |_________________________| 
	  |                         | KERNEL_THREAD_STACK_REGION_END = 0xDFFEF000
	  | Kernel thread stacks    |   = 16MB
	  |_________________________| KERNEL_THREAD_STACK_REGION_START = 0xDEFEF000
	  |                         |
      | Unused                  |
	  |_________________________|
      |                         | KERNEL_SLAB_ALLOCATOR_END = 0xD8500000
      |                         |
      |                         |   
      | SLAB Allocator          |
      |                         |   = 128MB
      ...
      |                         |
      |                         |
      |_________________________| KERNEL_SLAB_ALLOCATOR_START = 0xD0500000
      |                         |
      | Unused                  |
      |_________________________|
...
#define     KERNEL_THREAD_STACK_REGION_START    0xDEFEF000
#define     KERNEL_THREAD_STACK_REGION_END      0xDFFEF000
#define     KERNEL_THREAD_STACK_REGION_SIZE     (KERNEL_THREAD_STACK_REGION_END - KERNEL_THREAD_STACK_REGION_START)

#define     KERNEL_SLAB_ALLOCATOR_START         0xD0500000
#define     KERNEL_SLAB_ALLOCATOR_END           0xD8500000
#define     KERNEL_SLAB_ALLOCATOR_SIZE          (KERNEL_SLAB_ALLOCATOR_END - KERNEL_SLAB_ALLOCATOR_START)*/
