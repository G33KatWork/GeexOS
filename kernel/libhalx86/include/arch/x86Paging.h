...
namespace Arch
{
    ...
    private:
        ...
        /**
         * This function is used in the early initialization of the paging
         * it assumes that the current page directory and page table adresses
         * which are searched in this function are identity mapped.
        **/
        Address earlyFindPhysicalAddress(Address virt);
    };
}
