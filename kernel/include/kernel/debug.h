...
#define EN_DEBUG_MSG_STATIC_ALLOC
...
#ifdef EN_DEBUG_MSG_STATIC_ALLOC
    #define STATIC_ALLOC_DEBUG_MSG(x)           DEBUG_MSG("STATIC_ALLOC: "x)
#else
    #define STATIC_ALLOC_DEBUG_MSG(x)
#endif
