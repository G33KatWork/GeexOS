...
unsigned nroot_nodes;                    // Number of file nodes.

struct dirent dirent;

unsigned initrd_read(fs_node_t *node, unsigned offset, unsigned size, char *buffer)
{
...
struct dirent *initrd_readdir(fs_node_t *node, unsigned index)
{
